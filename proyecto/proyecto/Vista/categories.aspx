<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categories.aspx.cs" Inherits="proyecto.Vista.categories" %>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.aspx"><img src="images/logo.png" class="logo" alt="" style="width:150px;height:100px;"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
								...
								<li><a href="shop-detail.html">Automotive</a></li>
                                <li><a href="cart.html">Beauty & Personal Care</a></li>
                                <li><a href="checkout.html">Books</a></li>
                                <li><a href="my-account.html">Fashion</a></li>
                                <li><a href="wishlist.html">More</a></li>
                            </ul>
                        </li>
                        -->
                ...
                <div class="attr-nav">
                    <ul>
                        <li class="search"><a href="shop.aspx"><i class="fa fa-search"></i></a></li>
                        <li class="side-menu">
							<a href="cart.aspx">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-icon">
                                    <a href="#"> <img src="images/categories/cat-babies-1.png" style="width:80px;height:80px;" alt="" /> </a>
                                </div>
                                -->
                                <a href="#"> <img src="images/categories/cat-babies-1.png" style="width:80px;height:80px;" alt="" /> </a>
                                <div class="service-desc">
                                    <h4>Babies</h4>
                                    <p>Car seats, feeding bottles, bib, etc</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-desc">
                                    <h4>Account</h4>
                                    <p>Edit username, name, and mobile number</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-desc">
                                    <!--<img src="images/cart-1.png" style="width:80px;height:80px;" alt="" />-->
                                    <h4>My Cart</h4>
                                    <p>Add or delete products from the cart</p>
                                </div>
                            </div>
                        </div>
                    </div>
